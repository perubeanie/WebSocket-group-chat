...
async function sendChatMessage(task, message) {
  const response = await fetch(BASEURL + "/tasks/" + task.id + "/messages", {
...
const API = { addTask, getTasks, getPublicTasks, getAllOwnedTasks, updateTask, deleteTask, selectTask, sendChatMessage, logIn, logOut, getUserInfo, getUsers, assignTask, removeAssignTask, completeTask }
export default API;
